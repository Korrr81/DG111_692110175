...
**คำตอบ: เพราะคือการ pass by valueไม่ได้นำ hpไปคำนวณ**

### 2.2 `lerp` — Local Scope

**คำถาม:** ทำไม `main()` ถึงมองไม่เห็นตัวแปร `result` ทั้งที่มันถูกประกาศไว้ในไฟล์เดียวกัน?

**คำตอบ: เพราะ result เป็นตัวแปร local ของ lerpถูกประกาศตัวแปรใน{}ของlerp**
...
**คำตอบ: เพราะ pass by value ค่าของdiceminมาไว้ที่ RandomRange**
...
**คำตอบ: `เพราะ pass by value ค่าของdiceminมาไว้ที่ percentOf`**
